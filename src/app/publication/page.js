export default function publication()
{
    return(
        ...
        <h1 className="heading text-xl md:text-2xl hover:text-blue-500 font-bold text-center  mt-[00px]">
          <span>ALL</span> PUBLICATIONS
        </h1>
         <div className="box bg-white dark:bg-gray-700 w-[700px] rounded-lg mt-4 p-6 transition duration-300 ">
          ...
          <div className="box bg-white dark:bg-gray-700 w-[700px]  mt-4 rounded-lg  p-6 transition duration-300 ">
            <i className="fas fa-atom text-4xl text-indigo-500 mb-4"></i> {/* Replace with your icon */}
            ...
            <p className="flex gap-4"> <span className="hover:text-blue-500">Amarjeet Singh Chauhan</span> <span className="hover:text-blue-500">Mohit Yadav</span> <span className="hover:text-blue-500">Aditya Vardhan</span> <span className="hover:text-blue-500">Sukdev Roy</span></p>
            <p className="text-gray-600 dark:text-gray-400 mt-2">
